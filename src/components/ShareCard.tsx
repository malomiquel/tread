...
const styles = StyleSheet.create({
  ...
  brandName: { color: INK, fontSize: 20, fontFamily: font.extrabold, letterSpacing: 3.4 },
  ...
  name: { color: INK, fontSize: 26, fontFamily: font.bold, letterSpacing: -0.4 },
  date: { color: INK_SOFT, fontSize: 16, fontFamily: font.medium, marginTop: 2 },

  heroRow: { flexDirection: "row", alignItems: "baseline", gap: 4, marginTop: 9 },
  hero: {
    color: INK, fontSize: 62.5, fontFamily: font.bold,
    letterSpacing: -0.99, fontVariant: ["tabular-nums"],
  },
  heroUnit: { color: INK_SOFT, fontSize: 18, fontFamily: font.bold, letterSpacing: -0.2 },
  ...
  statValue: {
    color: INK, fontSize: 22.5, fontFamily: font.semibold,
    letterSpacing: -0.4, fontVariant: ["tabular-nums"],
  },
  statUnit: { color: INK_FAINT, fontSize: 12, fontFamily: font.semibold },
  statLabel: { color: INK_FAINT, fontSize: 10.5, fontFamily: font.bold, letterSpacing: 1.2 },
});
